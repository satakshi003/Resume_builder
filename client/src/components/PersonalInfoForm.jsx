...
const PersonalInfoForm = ({data, onChange, removeBackground, setBackground}) => {
        ...
        {typeof data.image === 'object' && (
          <div className="flex flex-col gap-1 pl-4 text-sm">
            ...
            <label className="relative inline-flex items-center cursor-pointer text-gray-900 gap-3">
              ...
              <div className="w-9 h-5 bg-slate-300 rounded-full peer peer-checked:bg-green-600 transition-transform duration-200"></div>
