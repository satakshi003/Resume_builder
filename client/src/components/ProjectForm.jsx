  ...
  return (
    <div >
      <div className="flex items-center justify-between">
        ...
        <button onClick={addProject} className="flex items-center gap-2 px-2 py-1 text-sm bg-brand-50 text-brand-700 rounded-lg hover:bg-brand-100 transition-colors ">
